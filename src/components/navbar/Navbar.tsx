...
export const Navbar = () => {
  return (
    <div className="md:sticky top-0 md:w-full md:top-0 md:z-30 flex justify-between flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
      <Logo />
        ...
        <div className="flex flex-row-reverse items-center">
          ...
          <button className="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
            ...
            <div className="w-8 h-8 overflow-hidden rounded-full">
              <Image className="w-full h-full object-cover" src="/img/user.svg" alt="user profile" width={90} height={80} />
            </div> 
